...
<head>
    ...
    <title>Krist | Forgot Password</title>
...
<div class="main">
        ...
        <div class="container">
            <nav style="--bs-breadcrumb-divider: '>'; line-height: 40px;" aria-label="breadcrumb" >
                <ol class="breadcrumb" style="height: 40px; margin: 0px;">
                    ...
                    <li class="breadcrumb-item "><a href="#" class="nav_link_active">forgot password</a></li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container-fluid g-0">
        <div style="width: 300px; margin: 70px auto;">
            ...
            <div class="mb-3" style="font-size: 14px; color: #474B57;">
            ...
            <div>
                <form>
                    ...
                    <div class="mb-4">
                        <button type="submit" style="border-radius: 4px; width: 100%; background-color: #000; color: #fff; padding: 8px;" class="btn btn-primary text_f14">Send reset link</button>
                    </div>
                </form>
            </div>
        </div>
