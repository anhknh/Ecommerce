...
<div class="main">
        ...
        <div class="container">
            <nav style="--bs-breadcrumb-divider: '>'; line-height: 40px;" aria-label="breadcrumb" >
                <ol class="breadcrumb" style="height: 40px; margin: 0px;">
                    ...
                    <li class="breadcrumb-item "><a href="#" class="nav_link_active">Login</a></li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container-fluid g-0">
        <div style="width: 300px; margin: 70px auto;">
            <h3 class="text-center" style="margin-bottom: 60px;">Login</h3>
            <div class="mb-3 d-flex justify-content-center align-items-center" style=" border: 1px solid #000; border-radius: 4px;">
                <div>
                    <img src="<c:url value="/resources/image/Logo_Google.png"/>" alt="">
                </div>
                <div>
                    <a href="#" style="width: 100%; padding: 8px;" class="btn  text_f14">Continue with Google</a>
                </div>
            </div>
            <div class="mb-4">
                <div style="font-size: 12px; position: relative; top: 16px; left: 135px; z-index: 1; display: inline-block; background-color: #fff; padding: 8px;">
                    OR
                </div>
            ...
            <div>
                <form method="post" action="/login-user">
                    ...
                    <div class="text-end mb-4">
                        <a href="/login/forgot-password" style="text-decoration: none; color: #5C5F6A; font-size: 12px;">Forgot Password?</a>
                    </div>
                    <div class="mb-4">
                        <button type="submit" style="border-radius: 4px; width: 100%; background-color: #000; color: #fff; padding: 8px;" class="btn btn-primary text_f14">Login</button>
                    </div>
                    <div class="text-center mb-4">
                        <a href="/signup" style="text-decoration: none; color: #5C5F6A; font-size: 14px;">Don't have an account? Sign up</a>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div>
        ...
        <div class="container d-flex align-items-center" style="padding:72px 0 120px;">
            <div style="width: 272px; margin-right: 142px;">
                ...
                <p style="font-size: 14px; color: #5C5F6A; margin-bottom: 28px;">Connect with us on social networking</p>
            ...
            <div style="width: 484px; margin-right: 100px;">
                <div style=" margin-right: 72px; display: inline-block;">
                    ...
                    <p><a href="#" style="text-decoration: none; color: #5C5F6A; font-size: 14px; font-weight: 500; margin-bottom: 16px;">FAQ</a></p>
                    <p><a href="#" style="text-decoration: none; color: #5C5F6A; font-size: 14px; font-weight: 500; margin-bottom: 16px;">Terms of use</a></p>
                    <p><a href="#" style="text-decoration: none; color: #5C5F6A; font-size: 14px; font-weight: 500; margin-bottom: 16px;">Privacy Policy</a></p>

                </div>
                <div style=" margin-right: 72px; display: inline-block;">
                    <p style="font-size: 14px; font-weight: 500; color: #5C5F6A; margin-bottom: 40px;">COMPANY</p>
                    <p><a href="#" style="text-decoration: none; color: #5C5F6A; font-size: 14px; font-weight: 500; margin-bottom: 16px;">About us</a></p>
                    <p><a href="#" style="text-decoration: none; color: #5C5F6A; font-size: 14px; font-weight: 500; margin-bottom: 16px;">Contact</a></p>
                    <p><a href="#" style="text-decoration: none; color: #5C5F6A; font-size: 14px; font-weight: 500; margin-bottom: 16px;">Careers</a></p>

                </div>
                <div style=" margin-right: 72px; display: inline-block;">
                    <p style="font-size: 14px; font-weight: 500; color: #5C5F6A; margin-bottom: 40px;">SHOP</p>
                    <p><a href="#" style="text-decoration: none; color: #5C5F6A; font-size: 14px; font-weight: 500; margin-bottom: 16px;">My Account</a></p>
                    <p><a href="#" style="text-decoration: none; color: #5C5F6A; font-size: 14px; font-weight: 500; margin-bottom: 16px;">Checkout</a></p>
                    <p><a href="#" style="text-decoration: none; color: #5C5F6A; font-size: 14px; font-weight: 500; margin-bottom: 16px;">Cart</a></p>
