            ...
            <div class="row">
                <div class="col-3" style=" border-right: 1px solid #E6E7E8; padding: 36px 0;">
                    <div style="width: 242px;">
                        ...
                        <a href="/ecommerce/profile-detail" class="bg_profile_btn mb-3"
                           style="padding: 8px 24px; font-size: 14px; font-weight: 500; border-radius: 6px; text-decoration: none; color: #000; display:block;">
                ...
                <div class="col-9" style="padding: 0px 34px;">
                    ...
                    <div style="width: 400px;">
                        <form method="post" action="/ecommerce/profile-detail/change-detail">
                            <div class="mb-3">
                                <label for="input_avt" class="form-label"
                                       style="background-color: #F0F1FF; border-radius: 50%; display: inline-block; cursor: pointer;">
                                    <img id="img_avt" src="/resources/image/${customer.imageAvatar}" alt=""
                                         style="background-color: #F0F1FF; width: 48px; height: 48px; border-radius: 50%;">
                                </label>
                                <input type="file" name="imageAvatar" class="form-control" id="input_avt" style="display: none;">
                            </div>
                            <div class="mb-4">
                                <label for="email" class="form-label">
                                    Email
                                </label>
                                <input type="text" class="form-control" name="email" id="email" value="${customer.userId.email}">
                            </div>
                            <button style="background-color: #000; color: #fff;" type="submit" class="btn">Save
                                Changes
                            </button>
                        </form>
                        <div>
...
<!-- Xử lý ảnh -->
<script>
    var input_avt = document.getElementById("input_avt")
    var img_avt = document.getElementById("img_avt")

    input_avt.addEventListener("change", function () {
        let input = input_avt.value.replace("C:\\fakepath\\", "")
        img_avt.src = "/resources/image/" + input
        console.log(input)
    })
</script>
</body>
