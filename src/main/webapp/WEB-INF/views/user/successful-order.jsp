...
<head>
    ...
    <title>Krist | successful order</title>
        ...
        <div class="container" style="padding: 0;">
            <nav style="--bs-breadcrumb-divider: '>'; line-height: 40px;" aria-label="breadcrumb">
                <ol class="breadcrumb" style="height: 40px; margin: 0px;">
                    ...
                    <li class="breadcrumb-item "><a href="#" class="nav_link_active">Successful Order</a></li>
                </ol>
            </nav>
        </div>
    </div>
    <!-- content -->
    <div class="container-fluid" style="background-color: #D5E5D7; padding: 30px 0;">
        <div class="container">
            <h3 style="font-weight: 700;">Successful Order</h3>
        </div>
    </div>
        ...
        <div class="container">
            <div class="text-center" style="margin-top: 88px;">
                <div style="margin-bottom: 22px;">
                    <img src="/resources/image/successful_order.png" alt="">
                </div>
                <div style="margin-bottom: 22px;">
                    <h3 style="font-weight: 700;">Thank you for shopping</h3>
                </div>
                ...
                <div>
                    <div style="background-color: #000; padding: 8px 26px; display: inline-block; border-radius: 5px;">
                        <a href="/ecommerce/profile-orders" style="text-decoration: none; color:#fff; font-size: 18px;"> Go to
                            my account &#8594</a>
                    </div>
                </div>
            </div>
