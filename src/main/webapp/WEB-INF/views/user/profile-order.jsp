            ...
            <div class="row">
                <div class="col-3" style=" border-right: 1px solid #E6E7E8; padding: 36px 0;">
                    <div style="width: 242px;">
                        <a href="/ecommerce/profile-orders" class="bg_profile_btn mb-3"
                        ...
                        <div style="width: 670px; padding: 24px 0px; border-bottom: 1px solid #E6E7E8;">
                            <div style="margin-top: 24px;" class="d-flex justify-content-between align-items-center">
                                <div class="text-center" style="width: 80px ; height: 80px; background-color: #F6F6F6;">
                                    <img style="width: 75%;" src="/resources/image/${productImageService.getFirstProductImageByProductId(orderItem.productDetail.productId).nameImage}" alt="">
                                </div>

                                <div>
                                    <p style="font-size: 16px; font-weight: 500; margin-bottom: 8px;">${orderItem.productDetail.productId.productName}</p>
                                    <!-- product_cart_color -->
                                    <div style="width: 214px ; height:  24px;">
                                        <div style="font-size: 12px; font-weight: 500; color: #5C5F6A;">
                                            Ordered on: ${orderItem.orderId.orderDate}
                                        </div>
                                    </div>
                                    <div style="width: 214px ; height:  24px;">
                                ...
                                <div>
                                    <div class="d-flex justify-content-between align-items-center" style="width: 280px;">
                                        <div>
                                            <div style="font-size: 14px; font-weight: 500; padding-bottom: 4px; display: inline-block; border-bottom: 1px solid #000;">
                                        ...
                                        <div class="prevent_select"
                                            ...
                                            <a href="/ecommerce/product-detail?productId=${orderItem.productDetail.productId.productId}"
                                               style="text-decoration: none; color: #000; font-size: 14px; font-weight: 500;">View
                                                item</a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="mt-4">
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-start">
                                <li class="page-item">
                                    <a class="page-link" style="color: #5C5F6A" href="/ecommerce/profile-orders?page=0" aria-label="Previous">
                                        <span aria-hidden="true">&laquo;</span>
                                    </a>
                                </li>
                                <c:forEach items="${pagination}" var="p">
                                    <c:if test="${page.number == p}">
                                        <li class="page-item"><a class="page-link" style="color: #ffffff; background-color: #5C5F6A" href="/ecommerce/profile-orders?page=${p}">${p + 1}</a></li>
                                    </c:if>
                                    <c:if test="${page.number != p}">
                                        <li class="page-item"><a class="page-link" style="color: #5C5F6A" href="/ecommerce/profile-orders?page=${p}">${p + 1}</a></li>
                                    </c:if>

                                </c:forEach>
                                <li class="page-item">
                                    <a class="page-link" style="color: #5C5F6A" href="/ecommerce/profile-orders?page=${totalPage}" aria-label="Next">
