            ...
            <div class="row">
                <div class="col-3" style=" border-right: 1px solid #E6E7E8; padding: 36px 0;">
                    <div style="width: 242px;">
                        ...
                        <a href="/ecommerce/profile-address" class="bg_profile_btn mb-3"
                           style="padding: 8px 24px; font-size: 14px; font-weight: 500; border-radius: 6px; text-decoration: none; color: #000; display:block;">
                ...
                <div class="col-9" style="padding: 0px 34px;">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div style="width: 450px;">
                            <div style="padding-right:29px ; border-right: 1px solid #E6E7E8; ">
                                <form method="post" action="/ecommerce/profile-address/save">
                                    <div class="mb-3 display_none">
                                        <label for="idDetail" class="form-label">id</label>
                                        <input type="text" class="form-control" id="idDetail" name="idDetail">
                                    </div>
                                    <div class="mb-3">
                                        <label for="nameAddress" class="form-label">Name</label>
                                        <input type="text" class="form-control" id="nameAddress" name="nameCustomer">
                                    </div>
                                    <div class="mb-3">
                                        <label for="numberPhone" class="form-label">Phone number</label>
                                        <input type="text" class="form-control" id="numberPhone" name="phoneNumber">
                                    </div>
                                    <div class="mb-3">
                                        <label for="Address" class="form-label">Address</label>
                                        <input type="text" class="form-control" id="Address" name="addressCustomer">
                                    </div>
                                    <button type="submit" style="width: 100%;" class="btn text-light bg-dark">Save
                                        address
                                    </button>
                                </form>
                            </div>
                        ...
                        <div style="width: 438px;">
                            <c:forEach var="customerDetail" items="${listCustomerDetail}">
                                <div class="d-flex justify-content-between align-items-center" style="width: 100%;margin-top: 8px; padding-bottom: 8px; border-bottom: 1px solid #E6E7E8;">
                                    <div style="display: inline-block; margin-right: 18px;">
                                        <div class="display_none" style="margin-bottom: 8px;">id:
                                            <p class="idDetail-data" style="display: inline-block; margin-left: 8px; font-weight: 600; margin-bottom: 0;">${customerDetail.detailId}</p>
                                        </div>
                                        <div style="margin-bottom: 8px;">Name:
                                            <p class="name-Data" style="display: inline-block; margin-left: 8px; font-weight: 600; margin-bottom: 0;">${customerDetail.nameCustomer}</p>
                                        </div>
                                        <div style="margin-bottom: 8px;">Phone number:
                                            <p class="phone-Data" style="display: inline-block; margin-left: 8px; font-weight: 600; margin-bottom: 0;">${customerDetail.phoneNumber}</p>
                                        </div>
                                        <div style="margin-bottom: 8px;">Address:
                                            <p class="address-Data" style="display: inline-block; margin-left: 8px; font-weight: 600; margin-bottom: 0;">${customerDetail.addressCustomer}</p>
                                        </div>
                                    </div>
                                    <div style="display: inline-block;">
                                        <a class="btn-edit" href="#"
                                           style="font-weight: 500; text-decoration: none; color: #0b5ed7; display: block; margin-bottom: 8px;">Edit</a>
                                        <a href="/ecommerce/profile-address/delete?idCustomerDetail=${customerDetail.detailId}"
                                           style="font-weight: 500; text-decoration: none; color: #bb2d3b; display: block;">Delete</a>
                                    </div>
                                </div>
                            </c:forEach>
                        </div>
...
<script>
    ...
    const phoneData = document.querySelectorAll(".phone-Data");
    const addressData = document.querySelectorAll(".address-Data");
    const idDetailData = document.querySelectorAll(".idDetail-data");
    const btnEdit = document.querySelectorAll(".btn-edit");
    //form
    const formId = document.getElementById("idDetail");
    const formName = document.getElementById("nameAddress");
    const formAddress = document.getElementById("Address");
    const formPhone = document.getElementById("numberPhone");
    //set value form for data
    for(let i = 0 ; i < btnEdit.length ; i++) {
        btnEdit[i].addEventListener("click", ()=> {
            formId.value = idDetailData[i].textContent;
            formName.value = nameData[i].textContent;
            formAddress.value = addressData[i].textContent;
            formPhone.value = phoneData[i].textContent;
        })
    }
</script>
</body>
