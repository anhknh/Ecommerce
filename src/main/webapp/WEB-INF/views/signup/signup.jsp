        ...
        <div class="container d-flex align-items-center justify-content-between" style="height: 84px;">
                    ...
                    <div class="container-fluid">
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="/view/Listing.html">Categories</a>
                                </li>
                                <li class="nav-item">
            ...
            <div class="header_right d-flex align-items-center justify-content-end">
                <div class="input-group flex-nowrap">
                    ...
                    <input type="text" class="form-control" placeholder="Search products" style="border-left: none; padding: 8px 60px 8px 0px; ">
                </div>
                <div style="margin: 0px 46px;">
                    <!-- <i class="fa-solid fa-cart-shopping" style="font-size: 20px;"></i> -->
                    <a href="#"data-bs-toggle="modal" data-bs-target="#modal_cart">
                        <img src="<c:url value="/resources/image/Icon_cart.png"/>" alt="cart"></a>
                </div>
                <div>
                    <!-- <i class="fa-regular fa-user" style="font-size: 20px;"></i> -->
                    <a href="#"><img src="<c:url value="/resources/image/icon_user.png"/>" alt="user"></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <nav style="--bs-breadcrumb-divider: '>'; line-height: 40px;" aria-label="breadcrumb" >
                <ol class="breadcrumb" style="height: 40px; margin: 0px;">
                    ...
                    <li class="breadcrumb-item "><a href="#" class="nav_link_active">Sign up</a></li>
                </ol>
            </nav>
        </div>
    </div>
