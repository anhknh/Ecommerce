                ...
                <div style="background-color: #fff; border-radius: 6px; padding: 24px 40px; border: 1px solid #f6f7f8;">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <div class="input-group flex-nowrap" style="width: 240px;">
                                        ...
                                        <input type="text" class="form-control" placeholder="Search Categories" style="border-left: none; padding: 8px 10px 8px 0px; ">
                                    </div>
                                    </form>
                                </div>
                                <div>
                                    <div class="btn btn-dark" style="display: inline-block;" data-bs-toggle="modal" data-bs-target="#modalCategories" onclick="saveIdOrder('', null)">Add Categories</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="margin-bottom: 28px;">
                        <table class="table" style="border-top: 1px solid #E9E9EB;">
                            ...
                            <tbody>
                            <c:forEach var="category" items="${listCategories}" varStatus="ststus">
                                <tr>
                                    ...
                                    <td class="nameRow" style="padding: 12px 6px; line-height: 305%;">
                                        ${category.categoryName}
                                    </td>
                                    <td class="descriptionRow" style="padding: 12px 6px; line-height: 305%;">
                                        ...
                                        <div class="action_product d-inline-block" style="padding-left: 18px;">
                                            ...
                                            <div class="product_extral box_shadow_black display_none ">
                                                <ul  style="list-style: none; border: 1px solid #E9E9EB; border-radius: 6px;  padding: 4px 8px; background-color: #fff; width: 140px; margin: 0;">
                                                    <li style="padding: 4px 12px 4px; height: 40px;"><a class="d-block updateCategories" style="text-decoration: none; color: #000;" data-bs-toggle="modal" data-bs-target="#modalCategories" onclick="saveIdOrder(${category.categoryId}, ${ststus.index})">Edit</a></li>
                                                    <li style="padding: 4px 12px 4px;"><a href="/ecommerce/admin/categories/change-status?id=${category.categoryId}" class="d-block" style="text-decoration: none; color: #000;">Activated</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </td>
                    ...
                    <div>
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-end">
                                <li class="page-item">
                                    <a class="page-link" style="color: #5C5F6A" href="/ecommerce/admin/categories?page=0"
                                       aria-label="Previous">
                                ...
                                <c:forEach items="${pagination}" var="p">
                                    <c:if test="${page.number == p}">
                                        <li class="page-item"><a class="page-link"
                                                                 ...
                                                                 href="/ecommerce/admin/categories?page=${p}">${p + 1}</a>
                                        </li>
                                    </c:if>
                                    <c:if test="${page.number != p}">
                                ...
                                <li class="page-item">
                                    <a class="page-link" style="color: #5C5F6A"
                                       href="/ecommerce/admin/categories?page=${totalPage}" aria-label="Next">
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="margin-top: 100px;">
            ...
            <div class="modal-body"  style="padding:30px">
                <div>
                    <form method="post" action="/ecommerce/admin/categories/add">
                        <div class="d-none">
                            <input type="text" class="form-control" id="idCustomer" value="" name="idCategory">
                        </div>
                        <div class="mb-4">
                            <label for="nameCategories" class="form-label">Name</label>
                            <input type="text" class="form-control" id="nameCategories" name="categoryName" value="">
                        </div>
                        <div class="form-floating mb-3">
                            <textarea class="form-control" name="description" placeholder="Description" id="descriptionCategories" style="height: 100px"></textarea>
                            <label for="descriptionCategories">Description</label>
                        </div>
                        <div>
...
<script>
    const updateCustomer = document.querySelectorAll(".updateCategories");
    ...
    const nameRow = document.querySelectorAll(".nameRow")
    const descriptionRow = document.querySelectorAll(".descriptionRow")

    function saveIdOrder(id, index) {
        idCustomer.value = id;
        if(index != null) {
            nameCategories.value = nameRow[index].textContent.trim();
            descriptionCategories.value = descriptionRow[index].textContent.trim();
        } else {
