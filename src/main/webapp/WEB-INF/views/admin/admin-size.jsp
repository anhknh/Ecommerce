                    ...
                    <div class="d-flex justify-content-between" style="padding-bottom: 28px;">
                        ...
                        <div style="width: 350px;">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <div class="btn btn-dark" style="display: inline-block;" data-bs-toggle="modal" data-bs-target="#modalCategories" onclick="saveIdOrder('', null)">Add Size</div>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <tr>
                                    <td style="padding: 12px 6px;">
                                        <div class="d-flex justify-content-center align-items-center"  style="background-color: #F0F1FF; width: 48px; border-radius: 4px;">
                                            <div>
                                                <div class="avt_icon"  data-category-name="Size" data-bg-img="">
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-center" style="padding: 12px 6px; line-height: 305%;">
                                        <c:if test="${size.status == 'Active'}">
                                            <i class="fa-regular fa-check"></i>
                                        </c:if>
                                        <c:if test="${size.status == 'InActive'}">
                                        ...
                                        <div class="action_product d-inline-block" style="padding-left: 18px;">
                                            ...
                                            <div class="product_extral box_shadow_black display_none ">
                                                <ul  style="list-style: none; border: 1px solid #E9E9EB; border-radius: 6px;  padding: 4px 8px; background-color: #fff; width: 140px; margin: 0;">
                                                    <li style="padding: 4px 12px 4px; height: 40px;"><a class="d-block updateSize" style="text-decoration: none; color: #000;" data-bs-toggle="modal" data-bs-target="#modalCategories" onclick="saveIdOrder(${size.attributeId}, ${status.index})">Edit</a></li>
                                                    <li style="padding: 4px 12px 4px;"><a href="/ecommerce/admin/size/change-status?id=${size.attributeId}" class="d-block" style="text-decoration: none; color: #000;">Activated</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </td>
                    ...
                    <div>
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-end">
                                <li class="page-item">
                                    <a class="page-link" style="color: #5C5F6A" href="/ecommerce/admin/size?page=0"
                                       aria-label="Previous">
                                ...
                                <c:forEach items="${pagination}" var="p">
                                    <c:if test="${page.number == p}">
                                        <li class="page-item"><a class="page-link"
                                                                 ...
                                                                 href="/ecommerce/admin/size?page=${p}">${p + 1}</a>
                                        </li>
                                    </c:if>
                                    <c:if test="${page.number != p}">
                                ...
                                <li class="page-item">
                                    <a class="page-link" style="color: #5C5F6A"
                                       href="/ecommerce/admin/size?page=${totalPage}" aria-label="Next">
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="margin-top: 100px;">
            ...
            <div class="modal-body"  style="padding:30px">
                <div>
                    <form method="post" action="/ecommerce/admin/size/add">
                        <div class="display_none">
                            <input type="text" class="form-control" id="idCustomer" name="idSize" value="">
                        </div>
                        <div class="mb-4">
                            <label for="valueSize" class="form-label">Value</label>
                            <input type="text" class="form-control" name="valueSize" id="valueSize">
                        </div>
                        <div>
...
<script>
    ...
    function saveIdOrder(id, index) {
        idCustomer.value = id;
        if(index != null) {
            valueSize.value = valueRow[index].textContent.trim();
        } else {
            valueSize.value = "";
        }
    }
