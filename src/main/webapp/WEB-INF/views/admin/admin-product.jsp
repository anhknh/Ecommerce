                    ...
                    <div class="d-flex justify-content-between" style="padding-bottom: 28px;">
                        ...
                        <div style="width: 380px;">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a href="/ecommerce/admin/product-manage" class="btn btn-dark"
                                       style="display: inline-block;">Add products</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <tr>
                                    <td style="padding: 12px 6px;">
                                        <div class="d-flex justify-content-center align-items-center"
                                            ...
                                            <div>
                                                <div style="width: 46px; height: 46px; background: url('/resources/image/${productImageService.getFirstProductImageByProductId(product).nameImage}') no-repeat center center / cover; border: none;">
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                            ...
                                            <div class="product_extral box_shadow_black display_none ">
                                                <ul style="list-style: none; border: 1px solid #E9E9EB; border-radius: 6px;  padding: 4px 8px; background-color: #fff; width: 140px; margin: 0;">
                                                    <li style="padding: 4px 12px 4px; height: 40px;"><a
                                                            href="/ecommerce/admin/product-detail?productId=${product.productId}"
                                                            class="d-block"
                                                            style="text-decoration: none; color: #000;">View Detail</a>
                                                    </li>
                                                    <li style="padding: 4px 12px 4px;"><a
                                                            href="/ecommerce/admin/product-manage?productId=${product.productId}"
                                                            class="d-block"
                    ...
                    <div>
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-end">
                                <li class="page-item">
                                    <a class="page-link" style="color: #5C5F6A" href="/ecommerce/admin/product?page=0"
                                       aria-label="Previous">
                                ...
                                <c:forEach items="${pagination}" var="p">
                                    <c:if test="${page.number == p}">
                                        <li class="page-item"><a class="page-link"
                                                                 ...
                                                                 href="/ecommerce/admin/product?page=${p}">${p + 1}</a>
                                        </li>
                                    </c:if>
                                    <c:if test="${page.number != p}">
                                ...
                                <li class="page-item">
                                    <a class="page-link" style="color: #5C5F6A"
                                       href="/ecommerce/admin/product?page=${totalPage}" aria-label="Next">
